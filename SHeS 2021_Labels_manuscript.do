...
*Dairy
label variable Avg_Day_TotDairy "Mean daily intake (g) of total dairy - only cheese is disaggagregated"
label variable Avg_Day_Cheese "Mean daily intake (g) of cheese - incl composite dishes"
label variable Avg_Day_Milk "Mean daily intake (g) of milk - not incl composite dishes"
label variable Avg_Day_CreamDesserts "Mean daily intake (g) of fromage frais, cream, ice cream and dairy desserts - not incl composite dishes"
label variable Avg_Day_Yogurt "Mean daily intake (g) of yogurt - not incl composite dishes"
label variable Avg_Day_Butter "Mean daily intake (g) of butter - not incl composite dishes"
label variable Avg_Day_TotDairy_Indiv "Mean daily intake (g) of total - not incl disag cheese"
label variable Avg_Day_Cheese_Indiv "Mean daily intake (g) of cheese - not incl disag cheese"
label variable Avg_Day_WholeMilk "Mean daily intake (g) of whole milk - not incl composite dishes"
label variable Avg_Day_SemiMilk "Mean daily intake (g) of semi-skimmed milk - not incl composite dishes"
label variable Avg_Day_1Milk "Mean daily intake (g) of 1% milk - not incl composite dishes"
label variable Avg_Day_SkimMilk "Mean daily intake (g) of skimmed milk - not incl composite dishes"
label variable Avg_Day_OtherMilkCream "Mean daily intake (g) of other milk & cream- not incl composite dishes"
label variable Avg_Day_YogFromDessert "Mean daily intake (g) yogurt, fromage frais and other dairy desserts"
label variable Avg_Day_IceCream "Mean daily intake (g) of ice cream"
label variable Avg_Day_TotMilkYog "Mean daily intake (g) of milk and yogurt"

*Low fat/high fat dairy
label variable Avg_Day_HFTotDairy "Mean daily intake (g) of high fat total dairy - only cheese is disaggagregated"
label variable Avg_Day_HFCheese "Mean daily intake (g) of high fat cheese - incl composite dishes"
label variable Avg_Day_HFMilk "Mean daily intake (g) of high fat milk - not incl composite dishes"
label variable Avg_Day_HFCreamDesserts "Mean daily intake (g) of high fat fromage frais, cream, ice cream and dairy desserts - not incl composite dishes"
label variable Avg_Day_HFYogurt "Mean daily intake (g) of high fat yogurt - not incl composite dishes"
label variable Avg_Day_HFButter "Mean daily intake (g) of high fat butter - not incl composite dishes"
label variable Avg_Day_HFTotMilkYog "Mean daily intake (g) of high fat milk and yogurt - not incl composite dishes"
label variable Avg_Day_LFTotDairy "Mean daily intake (g) of low fat total dairy - only cheese is disaggagregated"
label variable Avg_Day_LFCheese "Mean daily intake (g) of low fat cheese - incl composite dishes"
label variable Avg_Day_LFMilk "Mean daily intake (g) of low fat milk - not incl composite dishes"
label variable Avg_Day_LFCreamDesserts "Mean daily intake (g) of low fat fromage frais, cream, ice cream and dairy desserts - not incl composite dishes"
label variable Avg_Day_LFYogurt "Mean daily intake (g) of low fat yogurt - not incl composite dishes"
label variable Avg_Day_LFButter "Mean daily intake (g) of low fat butter - not incl composite dishes"
label variable Avg_Day_LFTotMilkYog "Mean daily intake (g) of low fat milk and yogurt - not incl composite dishes"
...
label variable Avg_VitaminA_FC1 "Mean daily intake (g) of vitamin A from food cat 1 - cereals and cereal products"
label variable Avg_VitaminA_FC2 "Mean daily intake (g) of vitamin A from food cat 2 - milk and milk products"
label variable Avg_VitaminA_FC3 "Mean daily intake (g) of vitamin A from food cat 3 - eggs and egg dishes"
label variable Avg_VitaminA_FC4 "Mean daily intake (g) of vitamin A from food cat 4 - fat spreads"
label variable Avg_VitaminA_FC5 "Mean daily intake (g) of vitamin A from food cat 5 - meat and meat products"
label variable Avg_VitaminA_FC6 "Mean daily intake (g) of vitamin A from food cat 6 - fish and fish dishes"
label variable Avg_VitaminA_FC7 "Mean daily intake (g) of vitamin A from food cat 7 - sandwiches"
label variable Avg_VitaminA_FC8 "Mean daily intake (g) of vitamin A from food cat 8 - vegetables, potatoes"
label variable Avg_VitaminA_FC9 "Mean daily intake (g) of vitamin A from food cat 9 - fruit"
label variable Avg_VitaminA_FC10 "Mean daily intake (g) of vitamin A from food cat 10 - sugars, preserves and confectionery"
label variable Avg_VitaminA_FC11 "Mean daily intake (g) of vitamin A from food cat 11 - savoury snacks"
label variable Avg_VitaminA_FC12 "Mean daily intake (g) of vitamin A from food cat 12 - nuts and seeds"
label variable Avg_VitaminA_FC13 "Mean daily intake (g) of vitamin A from food cat 13 - non-alcoholic beverages"
label variable Avg_VitaminA_FC14 "Mean daily intake (g) of vitamin A from food cat 14 - alcoholic beverages"
label variable Avg_VitaminA_FC15 "Mean daily intake (g) of vitamin A from food cat 15 - misc"
label variable Avg_VitaminA_FC16 "Mean daily intake (g) of vitamin A from food cat 16 - toddler foods"
label variable Avg_VitaminA_FC17 "Mean daily intake (g) of vitamin A from food cat 17 - artificial sweeteners"
label variable Avg_VitaminA_FC18 "Mean daily intake (g) of vitamin A from food cat 18 - dairy-free milk and milk products"
...
label variable Avg_VitaminA_NFC1 "Mean daily intake (g) of vitamin A from collapsed food category 1 - meat and meat products"
label variable Avg_VitaminA_NFC2 "Mean daily intake (g) of vitamin A from collapsed food category 2 - milk and milk products"
label variable Avg_VitaminA_NFC3 "Mean daily intake (g) of vitamin A from collapsed food category 3 - sandwiches"
label variable Avg_VitaminA_NFC4 "Mean daily intake (g) of vitamin A from collapsed food category 4 - other"
...
label variable Prop_Avg_Day_Milk "% cont of milk (not incl comp dishes) to total dairy intake"
label variable Prop_Avg_Day_Cheese "% cont of cheese (incl comp dishes) to total dairy intake"
label variable Prop_Avg_Day_Yogurt "% cont of yogurt (not incl comp dishes) to total dairy intake"
label variable Prop_Avg_Day_CreamDesserts "% cont of cream, ice cream and dairy desserts (not incl comp dishes) to total dairy intake"
label variable Prop_Avg_Day_Butter "% cont of butter (not incl comp dishes) to total dairy intake"
...
label variable Prop_Avg_Day_LFMilk "Proportion of milk consumed that is low fat"
label variable Prop_Avg_Day_LFYogurt "Proportion of yogurt consumed that is low fat"
label variable Prop_Avg_Day_LFCheese "Proportion of cheese (from non composite dishes) consumed that is low fat"
label variable Prop_Avg_Day_LFButter "Proportion of butter consumed that is low fat"
label variable Prop_Avg_Day_LFCreamDesserts "Proportion of cream & dairy desserts consumed that is low fat"
label variable Prop_Avg_Day_LFTotMilkYog "Proportion of milk and yogurt consumed that is low fat"
label variable Prop_Avg_Day_LFTotDairy "Proportion of total dairy consumed that is low fat"
label variable Prop_Avg_Day_LFButter "Proportion of butter consumed that is low fat"
label variable Prop_Avg_Day_LFCheese "Proportion of cheese consumed that is low fat (not incl composite dishes)"

label variable Prop_Avg_Day_HFMilk "Proportion of milk consumed that is high fat"
label variable Prop_Avg_Day_HFYogurt "Proportion of yogurt consumed that is high fat"
label variable Prop_Avg_Day_HFCheese "Proportion of cheese (from non composite dishes) consumed that is high fat"
label variable Prop_Avg_Day_HFButter "Proportion of butter consumed that is high fat"
label variable Prop_Avg_Day_HFCreamDesserts "Proportion of cream & dairy desserts consumed that is high fat"
label variable Prop_Avg_Day_HFTotMilkYog "Proportion of milk and yogurt consumed that is high fat"
label variable Prop_Avg_Day_HFTotDairy "Proportion of total dairy consumed that is high fat"
label variable Prop_Avg_Day_HFButter "Proportion of butter consumed that is high fat"
label variable Prop_Avg_Day_HFCheese "Proportion of cheese consumed that is high fat (not incl composite dishes)"
